...
const char* estadoRiego_topic = "estadoRiego";
...
void stadoRiego (){
  Serial.print("Estado de led");
  Serial.println(primerCaracter);
  if (client.publish(estadoRiego_topic, String(primerCaracter).c_str())) {
    Serial.println("Estado Riego Enviado!");
  } else {
    client.connect(clientID, mqtt_username, mqtt_password);
    delay(10); // This delay ensures that client.publish doesn't clash with the client.connect call
    client.publish(estadoRiego_topic, String(primerCaracter).c_str());
  }
}
/**
...
void loop() {
 ...
 // En ocasiones puede devolver datos erróneos; por eso lo comprobamos
  ...
  if (client.publish(caudalAgua_topic, String(caudalAgua).c_str())) {
    Serial.println("Caudal de agua sent!");
  } else {
    client.connect(clientID, mqtt_username, mqtt_password);
    delay(10); // This delay ensures that client.publish doesn't clash with the client.connect call
